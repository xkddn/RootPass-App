...
function applySchema(database) {
  ...
  `)
  try {
    database.exec(`ALTER TABLE accounts ADD COLUMN tags TEXT`)
  } catch {}
  try {
    database.exec(`ALTER TABLE accounts ADD COLUMN folder_id TEXT`)
  } catch {}
  try {
    database.exec(`ALTER TABLE folders ADD COLUMN sort_order INTEGER DEFAULT 0`)
  } catch {}
  try {
    database.exec(`ALTER TABLE master_check ADD COLUMN hint TEXT`)
  } catch {}
}
