...
function UpdateNotification() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[9998] w-full max-w-xs rounded-2xl border border-white/[0.08] bg-[#0C0C10] p-4 shadow-2xl shadow-black/60 animate-in slide-in-from-bottom-4 fade-in duration-300">
