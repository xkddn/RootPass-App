      ...
      {open &&
        createPortal(
          <div
            ...
            className="fixed z-[9999] overflow-hidden rounded-xl border border-white/[0.07] bg-(--surface-solid) py-1 shadow-2xl shadow-black/60 animate-in fade-in slide-in-from-top-1 duration-150"
          >
