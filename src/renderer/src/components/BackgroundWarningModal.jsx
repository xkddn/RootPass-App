...
function BackgroundWarningModal({ shortcut, onOk }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-white/[0.08] bg-(--surface-solid) p-6 shadow-2xl shadow-black/60 animate-in zoom-in-95 fade-in duration-200">
