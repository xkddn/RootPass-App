...
/**
 * @param {{ account: { id: number, title?: string, url?: string, login?: string, password?: string, category?: string, custom_fields?: string }, onClose: () => void, onSuccess: () => void, onDelete: () => void }} props
 */
function EditAccountModal({ account, onClose, onSuccess, onDelete }) {
